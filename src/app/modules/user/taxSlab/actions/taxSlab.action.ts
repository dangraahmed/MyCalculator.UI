...
export namespace TaxSlab {
    ...
    export const ActionTypes: ITaxSlabActions = {
        LOAD_TAX_SLAB: `${CATEGORY} Load`,
        LOAD_TAX_SLAB_SUCCESSFUL: `${CATEGORY} Load Successful`,
        LOAD_TAX_SLAB_FAILED: `${CATEGORY} Load Failed`,

        SELECT_TAX_SLAB: `${CATEGORY} Select`,

        LOAD_TAX_SLAB_DETAIL: `${CATEGORY} Detail Load`,
        LOAD_TAX_SLAB_DETAIL_SUCCESSFUL: `${CATEGORY} Detail Load Successful`,
        LOAD_TAX_SLAB_DETAIL_FAILED: `${CATEGORY} Detail Load Failed`,

        ADD_UPDATE_TAX_SLAB: `${CATEGORY} Add Or Update`,
        ADD_UPDATE_TAX_SLAB_SUCCESSFUL: `${CATEGORY} Add Or Update Successful`,
        ADD_UPDATE_TAX_SLAB_FAILED: `${CATEGORY} Add Or Update Failed`,

        DELETE_TAX_SLAB: `${CATEGORY} Delete`,
        DELETE_TAX_SLAB_SUCCESSFUL: `${CATEGORY} Delete Successful`,
        DELETE_TAX_SLAB_FAILED: `${CATEGORY} Delete Failed`
    };
